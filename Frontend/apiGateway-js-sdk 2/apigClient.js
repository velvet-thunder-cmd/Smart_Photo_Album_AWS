...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://m91uhvnsn1.execute-api.us-east-1.amazonaws.com/Prod';
    ...
    apigClient.uploadimagePut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var uploadimagePutRequest = {
            verb: 'put'.toUpperCase(),
        ...
        return apiGatewayClient.makeRequest(uploadimagePutRequest, authType, additionalParams, config.apiKey);
    };
